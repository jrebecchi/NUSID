...
exports.changePassword = function (app, req, res, users){
...
exports.showChangePasswordForm = function (req, res){
    if(req.user !== undefined){
        req.flash('error', "Oups, you are already logged in !");
        res.redirect('/dashboard');
        return;
...
exports.showPasswordRecoverForm = function (req, res){
    if(req.user !== undefined){
        req.flash('error', "Oups, you are already logged in !");
        res.redirect('/dashboard');
        return;
...
exports.resetPassword = function (app, req, res, users){
    if(req.user !== undefined){
        req.flash('error', "Oups, you are already logged in !");
        res.redirect('/dashboard');
        return;
    ...
    users.load(function(err) {
        ...
        users.emailExists(email, function(err, exists) {
            ...
            if (exists) {
                ...
                app.mailer.send('emails/reset_password.ejs', {
