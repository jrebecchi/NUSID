...
exports.getCheckEmailExists = function (req, res, users){
...
exports.getCheckUsernameExists = function (req, res, users){
...
exports.getConfirmEmail = function(req, res, users){
...
exports.createUser = function (app, req, res, users){
                ...
                users.emailExists(email, function(err, exists) {
                    ...
                    if (exists) {
                        ...
                        users.createUser(username, email, password, extras, function (err) {
                            ...
                            sendConfirmationEmail(app, req, res, extras.emailConfirmationCode, email, function(err){
                                if (err) {
...
exports.getSendConfirmationEmail = function(app, req, res, users){
    sendConfirmationEmail(app, req, res, req.user.extras.emailConfirmationCode, req.user.email, function(err){
        if (err) {
            req.flash('error', "Mail not sent, an error has occured.");
        } else {
...
exports.postModifyPassword = function(req, res, users){
    var iv = new InputValidator();
...
exports.postModifyUsername = function(req, res, users){
   var iv = new InputValidator();
    var username = req.body.username;
...
exports.postModifyEmail = function(app, req, res, users){
    var iv = new InputValidator();
    var email = req.body.email;
        ...
        users.emailExists(email, function(err, exists) {
            ...
            if (exists) {
                ...
                users.changeEmail(req.user.email, email, emailConfirmationCode, function(err) {
                    ...
                    sendConfirmationEmail(app, req, res, emailConfirmationCode, email, function(err){
                        if (err) {
                            users.close();
...
exports.postModifyFirstName = function(req, res, users){
    var iv = new InputValidator();
    var firstName = req.body.first_name;
...
exports.postModifyLastName = function(req, res, users){
    var iv = new InputValidator();
    var lastName = req.body.last_name;
...
exports.postDeleteAccount = function(req, res, users){
    var password = req.body.password;
    users.load(function(err) {
        if(err){
            users.close();
...
var sendConfirmationEmail = function(app, req, res, confirmationToken, email, cb){
    app.mailer.send('emails/confirm_email.ejs', {
